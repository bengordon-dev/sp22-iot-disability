...
#include "Wire.h" // Used for the GY-521 board
#include <math.h>
...
// GY-521 setup code (Michael Schoeffler)
...
void loop() {
  ...
  // GY-521 code (Michael Schoeffler)
  ...
  // My variabes  
  acc_x = (double) accelerometer_x;
  acc_y = (double) accelerometer_y;
  acc_z = (double) accelerometer_z;
